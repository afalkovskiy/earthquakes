...
with col2:    
    yr = st.slider("Year range", min_value=0, max_value=5, value=1,  step=1)
...
with col4:    
    minMag = st.slider("Minimum magnitude", min_value=5.5, max_value=10., value=6.,  step=0.5)
...
fig = px.scatter_mapbox(df2, lat="lat", lon="lon", title='Eathquakes', size='mg',
                        ...
                        center=dict(lon=-8.674051848928324, lat=39.63074957184749), size_max=20, zoom=0.2)
